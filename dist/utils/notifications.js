"use strict";
/**
 * Система уведомлений для HimkaPlastic EcoTrack
 * Email, SMS и Push уведомления для клиентов
 */
...
class NotificationService {
     ...
     */
    sendOrderStatusNotification(orderId, status, userEmail, userPhone) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const notifications = [
                ...
                this.sendPushNotification(Object.assign(Object.assign({}, notificationData), { type: 'push' }))
            ];
            if (userPhone) {
                notifications.push(this.sendSmsNotification(Object.assign(Object.assign({}, notificationData), { type: 'sms' })));
            }
